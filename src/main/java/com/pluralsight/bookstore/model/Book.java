...
public class Book {
    ...
    @Min(1)
    @ApiModelProperty("Book's unit cost")
    private Float unitCost;

    @Column(length = 50)
    @NotNull
    @Size(min = 1, max = 50)
    @ApiModelProperty("Book's ISBN")
    private String isbn;
    ...
    @ApiModelProperty("Image of the book")
    private String imageUrl;

    @Column
    @ApiModelProperty("Language the book is written in")
    ...
    public Book (String title, String description, Float unitCost, String isbn,
